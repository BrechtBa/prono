...
describe('Cloud Functions', () => {
  ...
  describe('matchScore1Changed', () => {
    // Test Case: setting messages/11111/original to 'input' should cause 'INPUT' to be written to
    // messages/11111/uppercase
    it('should write to all users', () => {

      const fakeEvent = {
        data: new functions.database.DeltaSnapshot(null, null, null, 5, 'groupId1/competition/matches/matchId1/score1'),
      };
