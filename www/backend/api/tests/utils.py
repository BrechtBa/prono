...
class EC2016Test(PronoTest):
    ...
    def setUp(self):
        ...
        self.matchdata.append({'team1':self.team_dict['A1'], 'team2':self.team_dict['A2']} )
        self.matchdata.append({'team1':self.team_dict['A3'], 'team2':self.team_dict['A4']} )
        self.matchdata.append({'team1':self.team_dict['B1'], 'team2':self.team_dict['B2']} )
        self.matchdata.append({'team1':self.team_dict['B3'], 'team2':self.team_dict['B4']} )
        self.matchdata.append({'team1':self.team_dict['C1'], 'team2':self.team_dict['C2']} )
        self.matchdata.append({'team1':self.team_dict['C3'], 'team2':self.team_dict['C4']} )
        self.matchdata.append({'team1':self.team_dict['D1'], 'team2':self.team_dict['D2']} )
        self.matchdata.append({'team1':self.team_dict['D3'], 'team2':self.team_dict['D4']} )
        self.matchdata.append({'team1':self.team_dict['E1'], 'team2':self.team_dict['E2']} )
        self.matchdata.append({'team1':self.team_dict['E3'], 'team2':self.team_dict['E4']} )
        self.matchdata.append({'team1':self.team_dict['F1'], 'team2':self.team_dict['F2']} )
        self.matchdata.append({'team1':self.team_dict['F3'], 'team2':self.team_dict['F4']} )
        ...
        self.matchdata.append({'team1':self.team_dict['B2'], 'team2':self.team_dict['B4']} )
        self.matchdata.append({'team1':self.team_dict['A2'], 'team2':self.team_dict['A4']} )
        self.matchdata.append({'team1':self.team_dict['A1'], 'team2':self.team_dict['A3']} )
        self.matchdata.append({'team1':self.team_dict['B1'], 'team2':self.team_dict['B3']} )
        self.matchdata.append({'team1':self.team_dict['C2'], 'team2':self.team_dict['C4']} )
        self.matchdata.append({'team1':self.team_dict['C1'], 'team2':self.team_dict['C3']} )
        self.matchdata.append({'team1':self.team_dict['E2'], 'team2':self.team_dict['E4']} )
        self.matchdata.append({'team1':self.team_dict['D2'], 'team2':self.team_dict['D4']} )
        self.matchdata.append({'team1':self.team_dict['D1'], 'team2':self.team_dict['D3']} )
        self.matchdata.append({'team1':self.team_dict['E1'], 'team2':self.team_dict['E3']} )
        self.matchdata.append({'team1':self.team_dict['F2'], 'team2':self.team_dict['F4']} )
        self.matchdata.append({'team1':self.team_dict['F1'], 'team2':self.team_dict['F3']} )
        ...
        self.matchdata.append({'team1':self.team_dict['A2'], 'team2':self.team_dict['A3']} )
        self.matchdata.append({'team1':self.team_dict['A4'], 'team2':self.team_dict['A1']} )
        self.matchdata.append({'team1':self.team_dict['B2'], 'team2':self.team_dict['B3']} )
        self.matchdata.append({'team1':self.team_dict['B4'], 'team2':self.team_dict['B1']} )
        self.matchdata.append({'team1':self.team_dict['C2'], 'team2':self.team_dict['C3']} )
        self.matchdata.append({'team1':self.team_dict['C4'], 'team2':self.team_dict['C1']} )
        self.matchdata.append({'team1':self.team_dict['D2'], 'team2':self.team_dict['D3']} )
        self.matchdata.append({'team1':self.team_dict['D4'], 'team2':self.team_dict['D1']} )
        self.matchdata.append({'team1':self.team_dict['E2'], 'team2':self.team_dict['E3']} )
        self.matchdata.append({'team1':self.team_dict['E4'], 'team2':self.team_dict['E1']} )
        self.matchdata.append({'team1':self.team_dict['F2'], 'team2':self.team_dict['F3']} )
        self.matchdata.append({'team1':self.team_dict['F4'], 'team2':self.team_dict['F1']} )
        ...
        self.matchdata.append({'team1':self.team_dict['A2'], 'team2':self.team_dict['C2']} )
        self.matchdata.append({'team1':self.team_dict['B1'], 'team2':self.team_dict['A3']} )
        self.matchdata.append({'team1':self.team_dict['D1'], 'team2':self.team_dict['B3']} )
        self.matchdata.append({'team1':self.team_dict['A1'], 'team2':self.team_dict['D3']} )
        self.matchdata.append({'team1':self.team_dict['C1'], 'team2':self.team_dict['F3']} )
        self.matchdata.append({'team1':self.team_dict['F1'], 'team2':self.team_dict['E2']} )
        self.matchdata.append({'team1':self.team_dict['E1'], 'team2':self.team_dict['D2']} )
        self.matchdata.append({'team1':self.team_dict['B2'], 'team2':self.team_dict['F2']} )
        ...
        self.matchdata.append({'team1':self.team_dict['A2'], 'team2':self.team_dict['D1']} )
        self.matchdata.append({'team1':self.team_dict['B1'], 'team2':self.team_dict['E2']} )
        self.matchdata.append({'team1':self.team_dict['F3'], 'team2':self.team_dict['E1']} )
        self.matchdata.append({'team1':self.team_dict['D3'], 'team2':self.team_dict['B2']} )
        ...
        self.matchdata.append({'team1':self.team_dict['D1'], 'team2':self.team_dict['E2']} )
        self.matchdata.append({'team1':self.team_dict['F3'], 'team2':self.team_dict['B2']} )
        ...
        self.matchdata.append({'team1':self.team_dict['D1'], 'team2':self.team_dict['F3']} )
